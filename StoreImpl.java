...
public class StoreImpl extends UnicastRemoteObject implements StoreInterface {
   ...
   private void initializeInventory() {
      inventory = new ArrayList<>();
      inventory.add(new Item("item1", "Orange", 20, 1000));
      inventory.add(new Item("item4", "Watermelon", 20, 1000));
      inventory.add(new Item("1", "Apple", 0.5, 100));
      inventory.add(new Item("2", "Banana", 0.3, 150));
